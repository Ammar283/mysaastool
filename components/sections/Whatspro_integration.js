...
export default function Whatspro_integration() {
    return (
        <>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-lg-9">
                                <div className="section-title mb-50">
                                    ...
                                    {/* Text */}
                                    <p className="s-21 color--grey">Connect WhatsPro with your favorite tools to streamline your workflow.</p>
                                </div>
                            </div>
                        </div>
                        {/* TOOLS ROW */}
                        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                              ...
                              <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">PayPal - Payment Gateway</h6>
                                </Link>
                            </div>	{/* END TOOL #2 */}
                            {/* TOOL #3 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Shopify - E-Commerce</h6>
                                </Link>
                            </div>	{/* END TOOL #3 */}
                            {/* TOOL #4 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">FlowiseAI - AI Chatbot Builder
                                    </h6>
                                </Link>
                            </div>	{/* END TOOL #4 */}
                            {/* TOOL #5 */}
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Hubspot - CRM</h6>
                                </Link>
                            </div>	{/* END TOOL #6 */}
                            {/* TOOL #7 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Slack - Team Communication
                                    </h6>
                                </Link>
                            </div>	{/* END TOOL #7 */}
                             {/* TOOL #8 */}
                             <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Google Sheets - Data Management
                                    </h6>
                                </Link>
                            </div>	{/* END TOOL #8 */}
                        </div>	{/* END TOOLS ROW */}
