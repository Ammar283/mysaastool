                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                ...
                                {/* Text */}
                                <p className="s-21 color--grey">Connect Invoicly with your favorite tools to streamline operations.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 rows-2">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">GoCardless</h6>
                                        <p className="p-sm"> Payment Processing</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Mercadopago</h6>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Twilio</h6>
                                        <p className="p-sm">SMS Notifications</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Team Communication</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-6 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Workflow Automation</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-7 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">QuickBooks</h6>
                                        <p className="p-sm"> Accounting</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-8 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Xero</h6>
                                        <p className="p-sm">Accounting</p>
                                    </div>
                                </Link>
