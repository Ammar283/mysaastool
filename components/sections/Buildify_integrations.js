...
export default function Buildify_integrations() {
    return (
        <>
            <section id="integrations-1" className=" integrations-section bg--purple-100 pt-100 pb-100 ">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-50 w-700">Integrations</h2>
                                {/* Text */}
                                <p className="s-21 color--grey">Buildify AI seamlessly integrates with your favorite tools to enhance productivity.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 rows-2">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Google Cloud Storage </h6>
                                        <p className="p-sm">Cloud Storage</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">OpenAI API </h6>
                                        <p className="p-sm">AI Framework</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">ElevenLabs</h6>
                                        <p className="p-sm">Voice Generation</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">MidJourney </h6>
                                        <p className="p-sm">Image Generation</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Stable Diffusion </h6>
                                        <p className="p-sm">Image Generation</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-7 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">WordPress </h6>
                                        <p className="p-sm">CMS</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-8 r-12 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm"> Collaboration</p>
                                    </div>
                                </Link>
