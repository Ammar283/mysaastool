...
export default function CardifyIntegration() {
    return (
        <>
                        ...
                        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700 mb-3">WhatsApp - Messaging</h6>
                                </Link>
                            </div> {/* END TOOL #1 */}
                            {/* TOOL #2 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700 mb-3">Google Wallet - Digital Wallet </h6>
                                </Link>
                            </div> {/* END TOOL #2 */}
                            {/* TOOL #3 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700 mb-3">Slack - Team Communication </h6>
                                </Link>
                            </div> {/* END TOOL #3 */}
                            {/* TOOL #4 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700 mb-3">HubSpot - CRM</h6>
                                </Link>
                            </div> {/* END TOOL #4 */}
                            {/* TOOL #5 */}
                            <div className="col">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">LinkedIn - Social Networking</h6>
                                </Link>
                            </div> {/* END TOOL #6 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Stripe - Payment Processing
                                    </h6>
                                </Link>
                            </div> {/* END TOOL #7 */}
                            <div className="col">
