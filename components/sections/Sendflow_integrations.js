...
export default function Sendflow_integrations() {
    return (
        <>
            <section id="integrations-1" className="py-100 bg--green-100 integrations-section">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                ...
                                {/* Text */}
                                <p className="s-21 color--grey">SendFlow integrates seamlessly with popular tools to enhance your email marketing workflow.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 rows-2">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Amazon SES</h6>
                                        <p className="p-sm">SMTP Service</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">SendGrid</h6>
                                        <p className="p-sm">SMTP Service</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Mailgun</h6>
                                        <p className="p-sm">SMTP Service</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">ElasticEmail</h6>
                                        <p className="p-sm">SMTP Service</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">SparkPost</h6>
                                        <p className="p-sm">SMTP Service</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-6 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Automation Platform</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-7 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Stripe</h6>
                                        <p className="p-sm">Payment Gateway</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-8 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">PayPal</h6>
                                        <p className="p-sm">Payment Gateway</p>
                                    </div>
                                </Link>
