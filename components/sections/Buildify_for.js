...
export default function Buildify_for() {
    return (
        <>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-9">
                            <div className="section-title mb-80">
                                ...
                                {/* Text */}
                                <p className="s-21 color--grey">Buildify AI is designed for anyone looking to simplify content creation, coding, or customer engagement. Whether you’re a business owner, developer, or marketer, our platform has you covered.</p>
                            </div>
                        </div>
                    </div>
                    {/* FEATURES-2 WRAPPER */}
                        ...
                        <div className="row row-cols-1 row-cols-md-4">
                            ...
                            <div className="col">
                                <div className="fbox-2 fb-1 wow fadeInUp">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Marketers</h6>
                                        <p>Create compelling campaigns, social media posts, and ads effortlessly.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-2 fb-2 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Developers</h6>
                                        <p>Streamline coding and debugging with AI-powered tools.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-2 fb-3 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Content Creators</h6>
                                        <p>Generate blogs, videos, and visuals to captivate your audience.</p>
                                    </div>
                                </div>
                             ...
                             <div className="col">
                                <div className="fbox-2 fb-3 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Small Businesses</h6>
                                        <p>Enhance customer support and content with affordable AI solutions.</p>
                                    </div>
                                </div>
