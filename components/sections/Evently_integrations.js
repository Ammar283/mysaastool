...
export default function Evently_integrations() {
    return (
        <>
            <section id="integrations-2" className=" integrations-section">
                <div className="container">
                    {/* INTEGRATIONS-2 WRAPPER */}
                    <div className=" integrations-2-wrapper mb-100 bg--purple-100 r-12 text-center">
                        {/* SECTION TITLE */}
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-lg-9">
                                <div className="section-title mb-50">
                                    ...
                                    {/* Text */}
                                   <p>Connect Evently with your favorite tools to streamline workflows.</p>
                                </div>
                            </div>
                        </div>
                        {/* TOOLS ROW */}
                        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Google Analytics: Web Analytics</h6>
                                </Link>
                            </div>	{/* END TOOL #5 */}
                            {/* TOOL #6 */}
                            <div className="col">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Twilio: SMS Notifications</h6>
                                </Link>
                            </div>	{/* END TOOL #7 */}
                             {/* TOOL #8 */}
                             <div className="col">
