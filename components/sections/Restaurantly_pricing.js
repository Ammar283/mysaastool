...
export default function Restaurantly_pricing() {
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-8">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-45 w-700 mb-3">Pricing Plans for Every Restaurant   </h2>
                                <p className="color--grey">Choose the plan that fits your restaurant’s needs and scale as you grow..</p>
                                {/* TOGGLE BUTTON */}
                        ...
                        <div className="row row-cols-1 row-cols-md-3">
                            ...
                            <div className="col">
                                <div id="pt-1-1" className="p-table pricing-1-table bg--white-100 block-shadow r-12 wow fadeInUp">
                                    ...
                                    <ul className="pricing-features color--black ico-10 ico--green mt-25">
                                                ...
                                                <li><p><span className="flaticon-check" /> Menu Management</p></li>
                                                <li><p><span className="flaticon-check" /> Order Tracking</p></li>
                                                <li><p><span className="flaticon-check" /> Table Management</p></li>
                                                <li><p><span className="flaticon-check" /> Basic Analytics</p></li>
                                                <li><p><span className="flaticon-check" /> QR-Based Menus  </p></li>
                                                <li><p><span className="flaticon-check" /> Single Location Support</p></li>
                              ...
                              <div className="col">
                                <div id="pt-1-1" className="p-table pricing-1-table bg--white-100 block-shadow r-12 wow fadeInUp">
                                    ...
                                    {/* PRICING FEATURES */}
                                    <ul className="pricing-features color--black ico-10 ico--green mt-25">
                                    <li><p><span className="flaticon-check" /> All Starter Features</p></li>
                                                <li><p><span className="flaticon-check" /> Multi-Location Sync </p></li>
                                                <li><p><span className="flaticon-check" /> Advanced Analytics</p></li>
                                                <li><p><span className="flaticon-check" /> Customer Profiles</p></li>
                                                <li><p><span className="flaticon-check" /> Loyalty Integration  </p></li>
                                                <li><p><span className="flaticon-check" /> Priority Supports</p></li>
                            ...
                            <div className="col">
                                <div id="pt-1-2" className="p-table pricing-1-table bg--white-100 block-shadow r-12 wow fadeInUp">
                                    ...
                                    {/* PRICING FEATURES */}
                                    <ul className="pricing-features color--black ico-10 ico--green mt-25">
                                        <li><p><span className="flaticon-check" /> All Pro Features </p></li>
                                        ...
                                        <li><p><span className="flaticon-check" /> Staff Training</p></li>
                                        <li><p><span className="flaticon-check" /> Advanced Security</p></li>
                                    </ul>
                                </div>
                            </div>	{/* END BASIC PLAN */}
                            {/* ADVANCED PLAN */}
