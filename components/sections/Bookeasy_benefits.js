...
export default function Bookeasy_benefits() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div id="fb-12-1" className="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                            ...
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Salons & Spas</h5>
                                                <p>Manage appointments, staff schedules, and client payments effortlessly.</p>
                                            </div>
                                        </div>
                                        {/* FEATURE BOX #2 */}
                                        <div id="fb-12-2" className="fbox-12 bg--white-100 block-shadow r-12">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Consultants & Coaches</h5>
                                                <p>Offer virtual or in-person sessions with Zoom integration and branded pages.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        <div id="fb-12-3" className="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Healthcare Providers</h5>
                                                <p>Streamline patient bookings and reminders for clinics and practices.</p>
                                            </div>
                                        </div>
                                        {/* FEATURE BOX #4 */}
                                        <div id="fb-12-4" className="fbox-12 bg--white-100 block-shadow r-12">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Event Planners</h5>
                                                <p>Organize events and services with customizable schedules and payments.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-md-5 order-first order-md-2">
                            <div className="txt-block left-column wow fadeInLeft">
                                ...
                                {/* Title */}
                                <h2 className="s-46 w-700">Who Can Benefit from BookEasy?</h2>
                                {/* Text */}
                                <p>BookEasy is designed for businesses of all sizes looking to simplify service bookings and enhance operations.
                                </p>
