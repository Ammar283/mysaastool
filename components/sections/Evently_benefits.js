                    ...
                    <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div id="fb-12-1" className="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                            ...
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Event Organizers</h5>
                                                <p>Create and manage multiple events with tools tailored for efficiency.</p>
                                            </div>
                                        </div>
                                        {/* FEATURE BOX #2 */}
                                        <div id="fb-12-2" className="fbox-12 bg--white-100 block-shadow r-12">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Businesses</h5>
                                                <p>Host corporate events, webinars, or workshops with professional branding.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        <div id="fb-12-3" className="fbox-12 bg--white-100 block-shadow r-12 mb-30">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Non-Profits</h5>
                                                <p>Run fundraisers or community events with cost-effective ticketing.</p>
                                            </div>
                                        </div>
                                        {/* FEATURE BOX #4 */}
                                        <div id="fb-12-4" className="fbox-12 bg--white-100 block-shadow r-12">
                                            ...
                                            {/* Text */}
                                            <div className="fbox-txt">
                                                <h5 className="s-20 w-700">Venues & Promoters</h5>
                                                <p>Manage ticket sales and promotions for concerts, festivals, and more.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-md-5 order-first order-md-2">
                            <div className="txt-block left-column wow fadeInLeft">
                                ...
                                {/* Title */}
                                <h2 className="s-46 w-700">Who is Evently For?</h2>
                                {/* Text */}
                                <p>Evently is designed for anyone looking to streamline event planning and ticketing, from small businesses to large organizations.
                                </p>
