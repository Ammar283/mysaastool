...
export default function Invoicly_whychoose() {
    return (
        <>
            <section id="features-11" className="pt-100 pb-100 features-section division">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-9">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-50 w-700">Why Invoicly?</h2>
                                {/* Text */}
                                <p className="s-21 color--grey">Invoicly empowers businesses with intuitive tools to manage finances, automate workflows, and scale effortlessly.</p>
                            </div>
                        </div>
                    </div>
                    {/* FEATURES-11 WRAPPER */}
                        ...
                        <div className="row row-cols-1 row-cols-md-3 rows-3">
                            ...
                            <div className="col">
                                <div className="text-center fb-1 wow fadeInUp p-4 bg--green-100 r-10">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Multi-Business Management</h6>
                                        <p>Handle multiple businesses with different currencies in one platform.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="text-center fb-2 wow fadeInUp p-4 bg--green-100 r-10">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Effortless Invoicing</h6>
                            ...
                            <div className="col">
                                <div className="text-center fb-3 wow fadeInUp  p-4 bg--green-100 r-10">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Expense Tracking</h6>
                                        <p>Monitor and categorize expenses with ease.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="text-center fb-4 wow fadeInUp  p-4 bg--green-100 r-10">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Secure Cloud Platform</h6>
                                        <p>Access your data anytime, anywhere with top-tier security.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="text-center fb-5 wow fadeInUp p-4 bg--green-100 r-10">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Customizable Workflows</h6>
                                        <p>Tailor processes to fit your business needs.</p>
                                    </div>
                                </div>
