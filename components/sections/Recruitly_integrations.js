...
export default function Recruitly_integrations() {
    return (
        <>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                ...
                                {/* Text */}
                                <p className="s-21 color--grey">Connect Recruitly with your favorite tools to enhance your workflow.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 rows-2">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Communication</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">LinkedIn  </h6>
                                        <p className="p-sm">Job Posting</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Google Workspace</h6>
                                        <p className="p-sm">Productivity</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Zoom  </h6>
                                        <p className="p-sm">Video Conferencing</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 mb-30 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="in_tool-txt">
                                        <h6 className="s-20 w-700">Indeed  </h6>
                                        <p className="p-sm">Job Board</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-6 r-12 mb-30 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Project Management</p>
                                    </div>
                                </Link>
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-7 r-12 wow fadeInUp">
                                    ...
                                    <div className="in_tool-txt">
                                        ...
                                        <p className="p-sm">Email Marketing</p>
                                    </div>
                                </Link>
