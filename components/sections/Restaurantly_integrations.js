...
export default function Restaurantly_integrations() {
    return (
        <>
                        ...
                        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">OpenTable - Reservation Management</h6>
                                </Link>
                            </div>	{/* END TOOL #3 */}
                            {/* TOOL #4 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Toast POS - Point of Sale
                                    </h6>
                                </Link>
                            </div>	{/* END TOOL #4 */}
                            {/* TOOL #5 */}
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Google Analytics - Web Analytics 
                                    </h6>
                                </Link>
                            </div>	{/* END TOOL #7 */}
                             {/* TOOL #8 */}
